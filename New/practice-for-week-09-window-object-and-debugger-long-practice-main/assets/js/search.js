...
export function findFirstElementOfTag(tag) {
    ...
    // Your code here
    console.log(window.document.getElementsByTagName(tag)[0]);
}
...
export function findFirstElementOfClass(cls) {
    ...
    // Your code here
    console.log(window.document.getElementsByClassName(cls)[0]);
}
...
export function findElementsOfTag(tag) {
    ...
    // Your code here
    console.log(window.document.getElementsByTagName(tag));
}
...
export function findElementsOfClass(cls) {
    ...
    // Your code here
    console.log(window.document.getElementsByClassName(cls));
}
